# Harpreet Singh Resumes

This repository stores current and archived resume files for Harpreet Singh.

## Current Best Resume

- `final/Harpreet_Singh_Embedded_AI_Resume.docx`
- `final/Harpreet_Singh_Embedded_AI_Resume.pdf`
...
reference. Do not send those versions unless a specific role needs an older
format.
